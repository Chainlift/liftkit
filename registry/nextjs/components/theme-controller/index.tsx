            ...
            <div className="lk-theme-drawer">
              ...
              >
                <Column gap="md">
                  ...
                  <Card bgColor="surfacecontainerlowest" scaleFactor="body" className="position-relative">
...
`}
                  ...
                  <div>
                    <h2 className="capline m-bottom-lg">Mode</h2>
                  ...
                  <div>
                    <h2 className="capline m-bottom-lg">Globals</h2>
                    <Row alignItems="start" gap="md">
                      <input
                        type="color"
                        name="master"
